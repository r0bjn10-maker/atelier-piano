...
test('activating one repository only removes its own obsolete shell caches', async () => {
  ...
  const keys = ['atelier-piano-shell-%2FPiano%2F-v3.0', 'atelier-piano-shell-%2FPiano%2F-v3.4', 'atelier-piano-shell-%2FOther%2F-v3.0', 'atelier-piano-shell-v3.0.1', 'atelier-piano-samples-v2'];
